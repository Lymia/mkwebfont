use crate::gather_css::{RawCssRule, RawCssRuleDeclarations};
use arcstr::ArcStr;
use ego_tree::NodeId;
use enumset::{EnumSet, EnumSetType};
use lightningcss::properties::font::{AbsoluteFontWeight, FontStyle};
...
struct NodeProperties {
    font_stack: HashSet<Arc<[String]>, WyHashBuilder>,
...
pub struct ResolvedNodeProperties {
    pub font_stack: HashSet<Arc<[String]>, WyHashBuilder>,
...
impl RawNodeInfo {
    pub fn compute(document: &Html, rules: &[Arc<RawCssRule>]) -> Self {
